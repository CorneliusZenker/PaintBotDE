...
class RandomBot extends AIPlayer {
  ...
  public void initBot() {
    ...
    // You have 1000ms to init your bot
  }
  ...
  public void myUpdate() {
    ...
    /*
    * You have 5 ms to update you bot
    * Technically its 10 ms but you should only stress that, if you know what you are doing,
    * since it only takes 1 Timeout to disqualify your bot for the current game!!
    */
  }
}
